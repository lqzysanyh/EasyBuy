...
public class AdminProductServlet extends AbstractServlet {
	...
	//临时文件夹
	private static final String TMP_DIR_PATH = "D://tmp";
	private File tmpDir;
	//上传路径
	...
	public String toUpdateProduct(HttpServletRequest request,HttpServletResponse response)throws Exception{
		...
		CategoryParam params =new CategoryParam();
		params.setType(1);
		List<Category> categoryList1=categoryService.queryCategoryList(params);
		params.setType(2);
		List<Category> categoryList2=categoryService.queryCategoryList(params);
		params.setType(3);
		List<Category> categoryList3=categoryService.queryCategoryList(params);
		//一级分类列表
