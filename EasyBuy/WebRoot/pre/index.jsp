...
<head>
    ...
    <script type="text/javascript" src="${ctx}/statics/js/index/index.js"></script>
    <title>楚游网</title>
</head>
<body>
<!--Begin Header Begin-->
...
<div class="i_bg bg_color">
    ...
    <!--Begin 进口 生鲜 Begin-->
    <c:forEach items="${categoryVoList}" var="temp" end="${fn:length(categoryVoList)}" varStatus="status">
