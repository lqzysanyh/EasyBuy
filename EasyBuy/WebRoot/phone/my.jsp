...
<%@ include file="common/titlePanle.jsp" %>
                <table border="0" style="width:370px; line-height:22px;" cellspacing="0" cellpadding="0">
                    <tr valign="top">
           ...
           <a href="Porder?action=index&userId=${loginUser.id}">我的收藏</a><br /><br />
					           <br /><br />
           <a href="PUser?action=toUpdateUser&id=${loginUser.id}">修改资料</a><br /><br />
           <a href="Porder?action=index&userId=${loginUser.id}">查看地址</a><br /><br />
                            </p>
                        </td>
                    </tr>
                </table>
