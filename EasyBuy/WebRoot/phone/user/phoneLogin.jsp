...
<%@ include file="../common/titlePanle.jsp" %>
		...
		<form>
            <table border="0" style="width:370px; font-size:14px; margin-top:30px;" cellspacing="0" cellpadding="0">
              ...
              <tr height="60">
                <td>手 机 号</td>
                <td><input type="text" name="phone" id="phone" value="" class="l_user" /></td>
              </tr>
              <tr height="60">
                <td>验 证 码</td>
                <td><input type="text" name="checkNum" id="checkNum" value="" class="l_pwd" />
                <span id="getNum" onclick="getNum();" style="color:#ff4e00;">获取验证码</span>
                <span id="DJS"><span id="DaoJiShi"></span></span>
                </td>
              </tr>
              <tr height="60">
              	<td><span>
              	<a href="${pageContext.request.contextPath }/PLogin?action=toLogin"
              	 style="color:#ff4e00;">账号登录</a></span></td>
